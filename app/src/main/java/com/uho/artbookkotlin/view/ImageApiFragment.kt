...
import com.uho.artbookkotlin.databinding.FrgmentImageApiBinding
...
class ImageApiFragment @Inject constructor(
...
): Fragment(R.layout.frgment_image_api) {

    lateinit var viewModel: ArtViewModel
    private var fragmentBinding: FrgmentImageApiBinding? =null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val binding = FrgmentImageApiBinding.bind(view)
        ...
        viewModel.imageList.observe(viewLifecycleOwner, Observer {
            when(it.status){
                Status.SUCCESS ->{
                    ...
                    fragmentBinding?.pbImage?.visibility = View.GONE
                }
                Status.ERROR -> {
                ...
                Status.LOADING ->{
                    fragmentBinding?.pbImage?.visibility = View.VISIBLE
                }
            }
        })
    }
